...
import { tableData,MyFormData } from "../Company_Admin_types/types";

const baseUrl = `https://dev-admin.sunrises.io/api/`;

export const getCompanyAdmins = async(tocken:string) => {
...
export const getDashboard = async(tocken:string)=>{
